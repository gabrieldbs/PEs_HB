...
real*8 diffNaalpha
real*8 pOhbeta,pHbeta,cohminbeta
integer i


!xmHplusalph:a=xHplusbulk
!xmBalpha =xmAalpha/ratioalpha  !b alpha demas para convergencia
!xmBalpha= (-exp(x(5))*(ratiopol+1.)+xmxtot)/(ratiopol+1.)
xmBalpha=exp(x(1)) 
...
xmHplusbeta=exp(x(8))
pHbeta=-log10((xmHplusbeta*1.0d24/Na))
pOHbeta=14.0 -pHbeta
cOHminbeta=10**(-pOhbeta)
xmOHminbeta=cOHminbeta*Na/(1.0d24)


!xmBalpha= (ratiopol*(xmAalpha+xmAbeta+xmBbeta)-xmBbeta)/(1-ratiopol)
!xmBalpha= ratiopol*(xmAalpha) 
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
vectfalpha(8)=1 !para identificar fase
...
!print*,'solv',xSolventalpha,xSolventbeta
...
diffnaalpha = xmNaalpha  - xmNaalphatot
!diffnaalpha = (xmClalpha  - xmNaalphatot)
!diffnaalpha = (xmNaalpha  - xmNaalphatot)*diffnaalpha

!diffnaalpha = xmClalpha  - xmNaalphatot
diffnaalpha = fasio_A_alpha*MA*xmAalpha +diffnaalpha !- xmNaalphatot
!diffnaalpha = fasio_B_alpha*MB*xmBalpha +diffnaalpha

!+ fasio_A_alpha*MA*xmAalpha) 
!diffnaalpha = (xmClalpha + fasio_B_alpha*MB*xmBalpha) +diffnaalpha- xmNaalphatot
xmaddedNaClalpha = xmNaalpha + fasio_A_alpha*MA*xmAalpha !mAalpha*MA
xmaddedClalpha = xmClalpha + fasio_B_alpha*MB*xmBalpha
xmaddedClbeta = xmClbeta + fasio_B_beta*MB*xmBbeta

xmaddedNaClbeta = xmNabeta + fasio_A_beta*MA*xmAbeta !mAalpha*MA
!xmaddedNaClbeta = xmClbeta + fasio_A_beta*MA*xmAbeta

!xmaddedNaClbeta = xmaddedNaClbeta +xmClbeta + fasio_B_beta*MB*xmBbeta
...
f(7)= diffnaalpha!  exp(x(1))-xmBalpha
f(8)=-potH/penality

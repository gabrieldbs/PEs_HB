...
real*8 logxmnaalphai,logxmnaalphaf,logxmnaalpha
integer npasosnaalpha
...
real*8 logxmaalphaf,logxmaalphai
real*8 xmaddedNaCl,ratiopol
integer npasosxtot, npasosratio ,npasosaalpha,npasosxmnaalpha
...
real*8 vsal,vs,vp
real*8 pKaHplus,pKHbulk,cHplusbulk,pHbulk
real*8 pKaOHmin,pOHbulk,cOHminbulk
real*8 expmupos, expmuneg, expmuHplus, expmuOHmin!,xmHplusbulk
integer ncsal
real*8 K0ANa,K0BCl
real*8 pKaA
real*8 pkaB
...
real*8 xmaddedClalpha, xmaddedClbeta
...
real*8 arrayaddedCla(100000)
real*8 arrayaddedClb(100000)

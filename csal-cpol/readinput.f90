...
read(8, *)  basura5
read(8, *)  logxmNaalphai, logxmNaalphaf, npasosxmNaalpha  ! scan na density in molar

!read(8, *) basura5
!read(8, *) csalini,csalfin,ncsal  ! salt concentration in bulk (Molar)

read(8, *)  basura6
read(8, *)  logxmAalphai, logxmAalphaf, npasosAalpha !npasosxtot   ! scan total monomer density
!
read(8, *)  basura7

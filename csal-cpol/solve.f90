...
!x1(8) =log(xmHplusalpha)!log(xmHplusbetainitial)      ! initial guess for xmNaalph
!x1g(8) = x1(8)

!x1(9) =log(xmHplusbeta)! log(xmOHminbetainitial)      ! initial guess for xmNaalpha
!x1g(9) = x1(9)
!print*,'in:alpha',exp(x1(1)),xmaalpha,exp(x1(1)),exp(x1(2)),exp(x1(3))!,exp(x1(10))
...
print*,'out:alpha',exp(x1(1)),exp(x1(2)),exp(x1(3))!,exp(x1(10))
...
! save arrays
    ...
    !  arrayaddedNaCl(yes)=xmaddedNaCl/Na*1.d24 !*vsol*vpos !/Na*1.d24
      ...
      arrayaddedCla(yes)=xmaddedClalpha/Na*1.d24 !*vsol*vpos !/Na*1.d24
      arrayaddedClb(yes)=xmaddedClbeta/Na*1.d24 !*vsol*vpos !/Na*1.d24
